...
public class TestApplication extends WebMvcConfigurerAdapter {
    ...
    @RequestMapping(value = "/api/simple-list", produces = "application/json")
    @ResponseBody
    public List<String> simpleList(@RequestHeader("X-Some-Header") String someHeader) {
        return asList("One", "Two", "Three");
    }

    @RequestMapping(value = "/api/long-list", produces = "application/json")
    @ResponseBody
